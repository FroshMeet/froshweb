        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            ...
            <div className="mb-8 animate-fade-in">
              <img src="/lovable-uploads/c3c223ba-561b-46c7-a410-e551d6b9a0bf.png" alt="Kian in graduation cap" className="w-80 h-80 mx-auto rounded-2xl object-cover shadow-2xl border border-border/20" />
            </div>
