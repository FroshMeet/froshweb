...
const SCHOOLS = [
  ...
  { name: "Brown University", acronym: "Brown", slug: "brown-university", searchTerms: ["Brown", "Brown University"] },
  ...
  { name: "Columbia University", acronym: "Columbia", slug: "columbia-university", searchTerms: ["Columbia", "Columbia University"] },
  { name: "Cornell University", acronym: "Cornell", slug: "cornell-university", searchTerms: ["Cornell", "Cornell University"] },
  { name: "Dartmouth College", acronym: "Dartmouth", slug: "dartmouth-college", searchTerms: ["Dartmouth", "Dartmouth College"] },
  { name: "Duke University", acronym: "Duke", slug: "duke-university", searchTerms: ["Duke", "Duke University"] },
  { name: "Florida State University", acronym: "FSU", slug: "fsu", searchTerms: ["FSU", "Florida State University", "Florida State"] },
  { name: "Georgetown University", acronym: "Georgetown", slug: "georgetown-university", searchTerms: ["Georgetown", "Georgetown University"] },
  { name: "Harvard University", acronym: "Harvard", slug: "harvard-university", searchTerms: ["Harvard", "Harvard University"] },
  { name: "Indiana University Bloomington", acronym: "IU Bloomington", slug: "iu", searchTerms: ["IU Bloomington", "Indiana University Bloomington", "Indiana University", "IU"] },
  ...
  { name: "Michigan State University", acronym: "Michigan State", slug: "msu", searchTerms: ["Michigan State", "Michigan State University", "MSU"] },
  { name: "New York University", acronym: "NYU", slug: "nyu", searchTerms: ["NYU", "New York University", "New York"] },
  { name: "Northeastern University", acronym: "Northeastern", slug: "northeastern-university", searchTerms: ["Northeastern", "Northeastern University"] },
  { name: "Northwestern University", acronym: "Northwestern", slug: "northwestern-university", searchTerms: ["Northwestern", "Northwestern University"] },
  { name: "Ohio State University", acronym: "Ohio State", slug: "osu", searchTerms: ["Ohio State", "Ohio State University", "OSU"] },
  { name: "Pennsylvania State University", acronym: "Penn State", slug: "psu", searchTerms: ["Penn State", "Pennsylvania State University", "PSU"] },
  { name: "Princeton University", acronym: "Princeton", slug: "princeton-university", searchTerms: ["Princeton", "Princeton University"] },
  { name: "Purdue University", acronym: "Purdue", slug: "purdue-university", searchTerms: ["Purdue", "Purdue University"] },
  { name: "Rice University", acronym: "Rice", slug: "rice-university", searchTerms: ["Rice", "Rice University"] },
  ...
  { name: "Stanford University", acronym: "Stanford", slug: "stanford-university", searchTerms: ["Stanford", "Stanford University"] },
  { name: "Texas A&M University", acronym: "Texas A&M", slug: "texas-aandm", searchTerms: ["Texas A&M", "Texas A&M University", "TAMU"] },
  { name: "University of Alabama", acronym: "UA", slug: "university-of-alabama", searchTerms: ["UA", "University of Alabama", "Alabama"] },
  { name: "University of Arizona", acronym: "UArizona", slug: "university-of-arizona", searchTerms: ["UArizona", "University of Arizona", "Arizona"] },
  ...
  { name: "University of California, San Diego", acronym: "UCSD", slug: "uc-san-diego", searchTerms: ["UCSD", "University of California San Diego", "San Diego", "UC San Diego"] },
  { name: "University of California, Santa Barbara", acronym: "UC Santa Barbara", slug: "uc-santa-barbara", searchTerms: ["UC Santa Barbara", "University of California Santa Barbara", "Santa Barbara", "UCSB"] },
  ...
  { name: "University of Miami", acronym: "UMiami", slug: "university-of-miami", searchTerms: ["UMiami", "University of Miami", "Miami"] },
  { name: "University of Michigan", acronym: "UMich", slug: "university-of-michigan", searchTerms: ["UMich", "University of Michigan", "Michigan"] },
  { name: "University of Minnesota", acronym: "UMN", slug: "university-of-minnesota", searchTerms: ["UMN", "University of Minnesota", "Minnesota"] },
  ...
  { name: "University of Oregon", acronym: "UOregon", slug: "university-of-oregon", searchTerms: ["UOregon", "University of Oregon", "Oregon"] },
  ...
  { name: "University of Texas at Austin", acronym: "UT Austin", slug: "ut", searchTerms: ["UT Austin", "University of Texas Austin", "Texas Austin", "UT"] },
  ...
  { name: "Vanderbilt University", acronym: "Vanderbilt", slug: "vanderbilt-university", searchTerms: ["Vanderbilt", "Vanderbilt University"] },
  ...
  { name: "Yale University", acronym: "Yale", slug: "yale-university", searchTerms: ["Yale", "Yale University"] }
];
            ...
            {filteredSchools.map((school) => (
              ...
              >
                <div className="bg-card/50 backdrop-blur-sm rounded-3xl p-8 text-center transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/30 border-2 border-primary/20 hover:border-primary/50 card-shadow group-hover:bg-card/80">
                  ...
                  {/* School Info */}
                  <h3 className="font-bold text-lg mb-2 group-hover:text-primary transition-colors text-primary">
