...
const WelcomeScreen = ({ onUserCreate, onGuestContinue }) => {
  ...
  // Enhanced college list with proper acronyms
  const colleges = [
    ...
    { name: "University of California, Berkeley", acronym: "UC Berkeley", searchTerms: ["berkeley", "cal", "uc berkeley"] },
    ...
    { name: "New York University", acronym: "NYU", searchTerms: ["nyu", "new york university"] },
    { name: "University of Michigan", acronym: "Michigan", searchTerms: ["michigan", "ann arbor", "wolverines"] },
    ...
    { name: "Georgia Institute of Technology", acronym: "Georgia Tech", searchTerms: ["georgia tech", "gt", "atlanta"] },
    { name: "California Institute of Technology", acronym: "Caltech", searchTerms: ["caltech", "pasadena"] },
